...
class ParamsApi {
  ...
  const ParamsApi(this._dio, this._serializers);
  ...
  Future<Response<void>> apiParamsCreateSectionPost({ 
    ...
    final _path = r'/api/Params/createSection';
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<BuiltList<CheckUpResponse>>> apiParamsGetCheckListBySectionGet({ 
    String? sectionid,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/Params/getCheckListBySection';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      if (sectionid != null) r'sectionid': encodeQueryParameter(_serializers, sectionid, const FullType(String)),
    };
  ...
  Future<Response<ParamSectionResponse>> apiParamsGetPreviousSectionGet({ 
    ...
    final _path = r'/api/Params/getPreviousSection';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<int>> apiParamsGetSectionCheckCountGet({ 
    String? name,
    String? id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/api/Params/getSectionCheckCount';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
